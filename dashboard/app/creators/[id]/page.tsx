...
export default async function CreatorDetailPage({
  ...
  const intel = readIntelligenceArtifacts(creator);
  ...
  return (
    <>
      ...
      <Panel
        ...
        subtitle={
          intel.markdown
            ? 'Generated by `intelligence_synth` against the cohort baseline. Pack JSON sidecar available at output/intelligence/.'
            : undefined
        }
        className="mb-6"
      >
        {intel.markdown ? (
          ...
          <Empty>
            No intelligence brief yet. Run{' '}
            <code className="font-mono text-xs">scripts/run_analysis.py --intelligence-only</code>{' '}
            to generate one (creator needs ≥5 featured posts).
          </Empty>
        )}
      </Panel>
